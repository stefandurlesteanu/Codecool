print("Please input your number folowed by a space and the base. \nLike in this example --> number_base.")
value_to_be_converted = input("Insert now: ")
value_to_be_converted = value_to_be_converted.split()

num_to_be_converted = int (value_to_be_converted [0])
base = int (value_to_be_converted [1])
    ...
    try:
        ...
        if base == 10:
            if num_to_be_converted > 0:
                ...
                return '1' + ''.join(int_list_to_str_list)
...
print('{initial_num} converted in {base} is {converted_num}'.format(initial_num = value_to_be_converted [0], base = converted_base, converted_num = convert_numbers(num_to_be_converted)))